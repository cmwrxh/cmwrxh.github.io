...
(function () {
  ...
  function restructureHomepageFooter() {
    ...
    footer.innerHTML='';footer.appendChild(first);footer.appendChild(col('Company',[['/about.html','About'],['/contact.html','Contact']]));footer.appendChild(col('Legal',[['/terms-of-service.html','Terms of Service'],['/privacy-policy.html','Privacy Policy'],['/acceptable-use-policy.html','Acceptable Use'],['/refund-policy.html','Refund Policy']]));footer.appendChild(col('Resources',[['/scan.html','Free Scan'],['/methodology.html','Methodology'],['/cases.html','Cases'],['/blog.html','Blog'],['/help-centre.html','Help centre']]));footer.appendChild(connect);
  }
